    ...
    <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
            <div class="space-y-5 sm:space-y-4">
                <h2 class="text-3xl font-extrabold text-center tracking-tight sm:text-4xl">Dibalik tirai.</h2>
                <p class="text-xl text-gray-400 text-center"> Debugging becomes significantly easier if you first admit that you are the problem.</p>
            </div>

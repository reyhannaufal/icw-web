    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="relative  py-2 shadow-xl sm:rounded-2xl sm:overflow-hidden">
            <div class="absolute inset-0 lg:mt-10">
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-purple-800 to-indigo-700"
            ...
            <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <p class="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                    Indonesian Corrossion Week (ICW) 2021 is an annual big event that held by Indonesian Association
                    Corrossion Student Chapter, Sepuluh Nopember Institute of Technology.
                </p>
                <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                    <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                        ...
                        <a onclick="_scrollTo(this, 'recap')"
                           class="cursor-pointer flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-500 bg-opacity-60 hover:bg-opacity-70 sm:px-8">
                            Last Recap
                        </a>
                    </div>
                </div>

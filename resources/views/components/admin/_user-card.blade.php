<div class="m-5 mb-10 mt-10">
    <div class="rounded card min-w-sm border border-gray-700 bg-gray-700 text-gray-50 transition-shadow shadow-xl hover:shadow-xl min-w-max">
        <!---->
                ...
                <div class="relative flex flex-col space-y-1 justify-center items-center w-full">
                    ...
                    <div class="py-4 flex space-x-2">
                        <button
                            ...
                            <span class="mr-2"></span>TOLAK<span class="ml-2"></span></button>
                        <button
                            ...
                            <span class="mr-2"><svg height="20" width="20" viewBox="0 0 32 32"
                                        ...
                                        d="M22.5,4c-2,0-3.9,0.8-5.3,2.2L16,7.4l-1.1-1.1C12,3.3,7.2,3.3,4.3,6.2c0,0-0.1,0.1-0.1,0.1c-3,3-3,7.8,0,10.8L16,29	l11.8-11.9c3-3,3-7.8,0-10.8C26.4,4.8,24.5,4,22.5,4z"></path></svg></span>TERIMA

...
<body class="font-body max-w-7xl min-w-min mx-auto py-40">

    <section class="flex flex-col xlplus:px-0 px-10 py-10">
        ...
        <div class="flex flex-row justify-center md:justify-between overflow-hidden bg-dashboard-0 rounded-lg w-auto z-10 relative shadow-md">
            ...
            <img src="public/assets/img/dash.png" alt="" class="absolute w-0 md:relative  md:w-2/4 ">
...
<x-app-layout>
    <div class="py-40">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-jet-welcome :events="$events" :announcements="$announcements" class="mt-32" />

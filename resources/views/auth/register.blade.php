        ...
        >
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 max-w">Isi data-data dibawah dengan benar</p>
                ...
                <div class="mt-8">
                    <div class="mt-6">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mt-4">
                                <x-jet-label for="institution" class="block text-sm font-medium text-gray-700" value="{{ __('Institusi') }}" />
